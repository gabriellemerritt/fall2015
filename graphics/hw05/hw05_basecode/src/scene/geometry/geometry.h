...
//Functions
    ...
    //Tangent / Bitangent Helper Functions
    virtual glm::vec3 CalculateTangent(const glm::vec3 &point1, const glm::vec3 &point2, const glm::vec3 &point3) ;
    virtual glm::vec3 CalculateBiTan( const glm::vec3 &point1, const glm::vec3 &point2, const glm::vec3 &point3) ;
    virtual Intersection RandomSample(float randX, float randY) = 0;
