...
public:
    ...
    void RaytraceScene();
    void deleteBVHTree(BVHNode *root);
    BVHNode* createBVHTree(BVHNode* root, QList<Triangle*> &tri, int depth);
    BVHNode* createBVHTree(BVHNode* root, QList<Geometry*> &box_geom, int depth);
    void DrawBb(BVHNode* root_node);
protected:
